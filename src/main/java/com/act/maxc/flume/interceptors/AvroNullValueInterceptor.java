 ...
 *
 */
public class AvroNullValueInterceptor implements Interceptor {

  private static final Logger logger = LoggerFactory
          .getLogger(AvroNullValueInterceptor.class);
...
//  private final List<String> nullValueList;
  
  /**
   * Only {@link AvroNullValueInterceptor.Builder} can build me
   */
  private AvroNullValueInterceptor() {
...
//    private String header = HOST;
    ...
    public Interceptor build() {
      return new AvroNullValueInterceptor();
    }
